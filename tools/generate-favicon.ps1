...
$source = Join-Path $root 'sk_favicon.png'
...
$targetWidth = 512 - ($sidePad * 2)
$targetHeight = [math]::Round($targetWidth * ($cropHeight / [double]$cropWidth))
$offsetY = [math]::Round((512 - $targetHeight) / 2.0)
$destRect = [System.Drawing.Rectangle]::new($sidePad, $offsetY, $targetWidth, $targetHeight)
