(function () {
   ...
   * @property {string} outsideCoverageLabel
   */
  ...
  /** @type {SiteConfig} */
  var siteConfig = {
    businessName: "SK Motor Services UK",
    ...
    responseWindowText: "1 hour quote response time.",
    legalDisclosure: "SK Motor Services UK is a trading name for PEAK TIME SOLUTIONS LTD (16183305).",
    coreCoverageLabel: "Primary Coverage: Brixton, Wandsworth, Mitcham, Sutton, Morden, Cheam, New Malden, Epsom.",
    outsideCoverageLabel: "Outside of Priority Area: All locations beyond the primary coverage zone."
  };
  ...
  var reviewSnippets = [
    ...
    },
    {
      ...
      source: "Google",
      rating: 5,
      quote: "This is the second time I have used SK Motor Services UK, and it is five stars all the way."
    }
  ];
